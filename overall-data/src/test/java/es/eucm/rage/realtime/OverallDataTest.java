...
import es.eucm.rage.realtime.simple.topologies.OverallDataBuiler;
...
/**
 * Tests the {@link OverallDataBuiler} executed on a local cluster and receiving
 * data from a local files VERBS_FILES
 */
public class OverallDataTest {
	...
	public void xAPIVerbsTest() throws IOException {
		...
		FeederBatchSpout tracesSpout = new FeederBatchSpout(Arrays.asList(
				OverallDataBuiler.SESSION_ID_KEY,
		...
		new OverallDataBuiler().build(topology,
