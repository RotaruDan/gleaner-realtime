...
public class IsCompletedAnalytics implements Filter {
	private static final Logger LOGGER = Logger.getLogger(IsCompletedAnalytics.class
			.getName());
	 ...
	 *
	 */
	public IsCompletedAnalytics(String analyticsKey, String gameplayKey, boolean completed) {
