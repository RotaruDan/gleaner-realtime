...
/**
 * Tests the {@link ThomasKilmannTopologyBuilder} executed on a local cluster
 * and receiving data from a local files TRACES_FILES
 */
public class RealtimeTopologyTest {
	...
	public void test() throws IOException {
		...
		FeederBatchSpout tracesSpout = new FeederBatchSpout(Arrays.asList(
				ThomasKilmannTopologyBuilder.SESSION_ID_KEY,
		...
		new ThomasKilmannTopologyBuilder().build(topology,
