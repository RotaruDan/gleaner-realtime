 ...
 * {@link ThomasKilmannTopologyBuilder} with the analysis configuration from
...
public class Analysis extends AbstractAnalysis {
	...
	private ThomasKilmannTopologyBuilder topologyBuilder = new ThomasKilmannTopologyBuilder();
